...
.DESCRIPTION
  ...
  with MTP speculative decoding (explicit --spec-type draft-mtp in v0.4.0+).

  Confirmed working on: v0.4.0 Preview, Windows x86_64, RTX 3090 24GB.
...
# v0.4.0+ requires explicit --spec-type draft-mtp (auto-detect was removed).
...
Write-Host ""
Write-Host "========================================"
Write-Host " BeeLlama v0.4.0 Sidecar Launch"
Write-Host "========================================"
...
$argList = @(
    ...
    # Speculative decoding: MTP (explicit in v0.4.0+; auto-detect was removed)
    "--spec-type",         "draft-mtp"
